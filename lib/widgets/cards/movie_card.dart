        ...
        children: [
          ClipRRect(
              ...
              child: movie.posterImg.contains('assets')
                  ? Image.asset(movie.posterImg,
                      width: 173, height: 224, fit: BoxFit.cover)
                  : Image.file(File(movie.posterImg),
                      width: 173, height: 224, fit: BoxFit.cover)),
              ...
              Row(
                children: [
                  const Icon(Icons.edit_outlined,
                      size: 20, color: Color(0xffF8F8F8)),
                  IconButton(
                      onPressed: () {
                        showDialog(
                            context: context,
